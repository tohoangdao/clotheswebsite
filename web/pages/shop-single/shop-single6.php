	...
	<div id="page">
						...
						<div id="content" role="main">
							...
							<div itemscope itemtype="http://schema.org/Product" class="product">
								<div class="images">
									...
									<img src="https://st.mngbcn.com/rcs/pics/static/T1/fotos/S20/17025764_52_B.jpg" alt=""></img></a>
								</div>
								<div class="summary entry-summary">
									<h1 itemprop="name" class="product_title entry-title">Pineapple T-shirt</h1>
									...
									<button class="btn btn-success cart-button px-5" onclick="addToCart('Pineapple T-shirt', 59.99)">
										Add to cart 
									</button>
								</div>
								<!-- .summary -->
		...
		<div class="cd-cart cd-cart--empty js-cd-cart" >
			<a href="#0" class="cd-cart__trigger text-replace">
				Cart
				<ul class="cd-cart__count" id ="6"> <!-- cart items count -->
					<li>0</li>
					<li>0</li>
				</ul> <!-- .cd-cart__count -->
			</a>
