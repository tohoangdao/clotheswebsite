...
<html lang="en-US">
	<head>
		...
		<?php include '../components/css_header.php' ?>
	</head>
<body class="single single-product woocommerce woocommerce-page">
	<div id="page">
				...
				<div id="primary" class="content-area column full">
					...
					<div id="container">
						<div id="content" role="main">
							<nav class="woocommerce-breadcrumb" itemprop="breadcrumb"><a href="#">Home</a> / <a href="#">Clothing</a></nav>
							<div itemscope itemtype="http://schema.org/Product" class="product">
								<div class="images">
									<a href="" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto">								
									<img src="https://st.mngbcn.com/rcs/pics/static/T1/fotos/S20/17087118_54_B.jpg" alt=""></img></a>
								</div>
								<div class="summary entry-summary">
									<h1 itemprop="name" class="product_title entry-title">Regular-fit striped shirt</h1>
									...
									<div itemprop="description">
										<p>
											Regular fit. Striped design. Cotton fabric. Buttoned collar. Long buttoned sleeve. Button up.
										</p>
									</div>
									<!-- <form class="cart" method="post" enctype='multipart/form-data'>
										<button type="submit" class="cd-add-to-cart js-cd-add-to-cart">Add to cart</button>
									</form> -->
									<button class="btn btn-success cart-button px-5" onclick="addToCart('Regular-fit striped shirt', 37.99)">
										Add to cart 
									</button>
								</div>
								<!-- .summary -->
		...
		<div class="cd-cart cd-cart--empty js-cd-cart" >
			<a href="#0" class="cd-cart__trigger text-replace">
				Cart
				<ul class="cd-cart__count" id ="4"> <!-- cart items count -->
					<li>0</li>
					<li>0</li>
				</ul> <!-- .cd-cart__count -->
			</a>
				...
				<div class="cd-cart__layout">
					...
					<footer class="cd-cart__footer">
						<a href="#0" class="cd-cart__checkout">
							<em onclick="window.open('./checkout.html')">Checkout - $<span>0</span>
	...
	<!-- #page -->
	<?php include '../components/js_footer.php' ?>
</body>
</html>