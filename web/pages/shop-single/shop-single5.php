	...
	<div id="page">
						...
						<div id="content" role="main">
							...
							<div itemscope itemtype="http://schema.org/Product" class="product">
								<div class="images">
									...
									<img src="https://st.mngbcn.com/rcs/pics/static/T8/fotos/S20/87057880_40_B.jpg" alt=""></img></a>
								</div>
								<div class="summary entry-summary">
									<h1 itemprop="name" class="product_title entry-title">Cotton linen regular-fit t-shirt</h1>
									...
									<div itemprop="description">
										<p>
											Regular fit. Cotton and linen mix. Rounded neck. Short sleeve.
										</p>
									</div>
									<!-- <form class="cart" method="post" enctype='multipart/form-data'>
										<button type="submit" class="cd-add-to-cart js-cd-add-to-cart">Add to cart</button>							
									</form> -->
									<button class="btn btn-success cart-button px-5" onclick="addToCart('Cotton linen regular-fit t-shirt', 39.99)">
										Add to cart 
									</button>
								</div>
								<!-- .summary -->
		...
		<div class="cd-cart cd-cart--empty js-cd-cart">
			<a href="#0" class="cd-cart__trigger text-replace">
				Cart
				<ul class="cd-cart__count" id ="5"> <!-- cart items count -->
					<li>0</li>
					<li>0</li>
				</ul> <!-- .cd-cart__count -->
			</a>
